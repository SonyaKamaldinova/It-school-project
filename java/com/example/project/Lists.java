...
public class Lists extends Activity {
	...
	private class MyAdapter extends ResourceCursorAdapter {
        ...
        public void bindView(View view, Context context, Cursor cur) {
        	TextView tvListName = (TextView)view.findViewById(R.id.itemName);
		ImageButton btnGoToList= (ImageButton) view.findViewById(R.id.btnGoToList);
		tvListName.setText(cur.getString(cur.getColumnIndex(DBAdapter.LISTNAME)));
