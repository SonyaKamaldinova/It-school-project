...
public class DBAdapter {
	...
	{
		Cursor c=null;
		c =db.query(ITEMS_TABLE_NAME, new String[] {PRODUCTID, ISDONE, TITLE}, LIST_ID+"="+ListId, null, null, null, null);
		return c;}
	public Cursor getListItem(long rowId) throws SQLException
	{
		Cursor mCursor =null;
		mCursor = db.query(true, LISTS_TABLE_NAME, new String[] {LISTID, LISTNAME}, LISTID + "=" + rowId, null, null, null, null, null);
		if (mCursor != null) {
			mCursor.moveToFirst();}
		return mCursor;}
	...
	{
		Cursor mCursor =null;
		mCursor = db.query(true, ITEMS_TABLE_NAME, new String[] {PRODUCTID, ISDONE, TITLE}, PRODUCTID + "=" + rowId, null, null, null, null, null);
		if (mCursor != null) {
			mCursor.moveToFirst();}
		return mCursor;
	}
